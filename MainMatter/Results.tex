...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{Imagen de colposcop\'ia \texttt{48-1.bmp} con su m\'ascara aplicada (en negro). En la ampliaci\'on los cuadros de bordes blancos representan los parches de $5 \times 5$ vac\'ios, y de naranja aquellos que tienen informaci\'on. Los cuadros de borde rojo, ejemplos de la vecindad de $6 \times 6$ explorable.}
