...
\input{Experiments/berkleyA}
\berkleyA{Resultados de los tres tipos de restauraciones para el grupo (A)}{tab:berkleyA}{teal}{red}

\input{Experiments/berkleyB}
\berkleyB{Resultados de los tres tipos de restauraciones para el grupo (B)}{tab:berkleyB}{teal}{red}