...
\begin{figure}[H]
	...
	\draw[-,black,ultra thick] (0, 0) rectangle (200, 320); %x
	\draw[-,black,ultra thick] (200, 0) rectangle (485, 320); %x
	\draw[-,black,ultra thick] (485, 0) rectangle (720, 250);
	\draw[-,black,ultra thick] (0, 320) rectangle (80, 480);
	\draw[-,black,ultra thick] (80, 320) rectangle (485, 480); %x
	\draw[-,black,ultra thick] (485, 250) rectangle (720, 480); %x
