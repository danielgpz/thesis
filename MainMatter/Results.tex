...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{Imagen de colposcop\'ia \texttt{48-1.bmp} con su m\'ascara aplicada (en negro). En la ampliaci\'on los cuadros de bordes blancos representan los parches de $5 \times 5$ vac\'ios, y de amarillo aquellos que tienen informaci\'on. Los cuadros de borde rojo, ejemplos de la vecindad de $6 \times 6$ explorable.}
...
\begin{figure}[H]
	...
	\draw[-,red,ultra thick] (0, 0) rectangle (200, 320); %x
	\draw[-,red,ultra thick] (200, 0) rectangle (485, 320); %x
	\draw[-,red,ultra thick] (485, 0) rectangle (720, 250);
	\draw[-,red,ultra thick] (0, 320) rectangle (80, 480);
	\draw[-,red,ultra thick] (80, 320) rectangle (485, 480); %x
	\draw[-,red,ultra thick] (485, 250) rectangle (720, 480); %x
	\draw[|-|, orange, line width=1pt] (100, 160) -- (-50, 160) node[left, black] {$\boxed{\sqrt{n} = 6}$};
	\draw[|-|, blue, line width=1pt] (342.5, 160) -- (770, 160) node[right, black] {$\boxed{\sqrt{n} = 16}$};
	\draw[|-|, black, line width=1pt] (282.5, 400) -- (-50, 400) node[left, black] {$\boxed{\sqrt{n} = 32}$};
	\draw[|-|, violet, line width=1pt] (602.5, 365)-- (770, 365) node[right, black] {$\boxed{\sqrt{n} = 8}$};
	\end{tikzpicture}
